...
class SetResponseHeaderModal extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            name: '',
    ...
    submitHandler = () => {
        ...
        if(isValid === true){
            addToParent('SetResponseHeader', obj);
    ...
    render(){
        ...
        return (
            <Modal open={modalOpen} size='mini'>
                <Header icon='save' content='SetResponseHeader Filter' />
                <Modal.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(SetResponseHeaderModal)
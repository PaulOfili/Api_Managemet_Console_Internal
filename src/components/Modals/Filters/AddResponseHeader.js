...
class AddResponseHeaderModal extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            name: '',
    ...
    submitHandler = () => {
        ...
        if(isValid === true){
            addToParent('AddResponseHeader', obj);
    ...
    render(){
        ...
        return (
            <Modal open={modalOpen} size='mini'>
                <Header icon='save' content='AddResponseHeader Filter' />
                <Modal.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddResponseHeaderModal)
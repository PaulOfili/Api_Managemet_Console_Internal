...
class RemoveResponseHeader extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            name: '',
    ...
    submitHandler = () => {
        ...
        if(isValid === true){
            addToParent('RemoveResponseHeader', obj);
    ...
    render(){
        ...
        return (
            <Modal open={modalOpen} size='mini'>
                <Header icon='save' content='RemoveResponseHeader Filter' />
                <Modal.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(RemoveResponseHeader)
...
class PreserveHostHeader extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            name: '',
    ...
    submitHandler = () => {
        ...
        if(isValid === true){
            addToParent('PreserveHostHeader', obj);
...
export default connect(mapStateToProps, mapDispatchToProps)(PreserveHostHeader)
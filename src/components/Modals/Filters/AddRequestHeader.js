...
class AddRequestHeaderModal extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            name: '',
    ...
    submitHandler = () => {
        ...
        if(isValid === true){
            addToParent('AddRequestHeader', obj);
    ...
    render(){
        ...
        return (
            <Modal open={modalOpen} size='mini'>
                <Header icon='save' content='AddRequestHeader Filter' />
                <Modal.Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddRequestHeaderModal)